...
public class Q5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("ENTER THE BOOKING ID");

        EE1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N

        jButton5.setFont(new java.awt.Font("Socrates", 1, 24)); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(126, 126, 126)
                                .addComponent(EE1, javax.swing.GroupLayout.DEFAULT_SIZE, 225, Short.MAX_VALUE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         try{
            ...
            String id = EE1.getText();
            int guest =Integer.parseInt(DD.getText());
            int days =Integer.parseInt(EE.getText());
            int bill =Integer.parseInt(HH.getText());
            String Q = "INSERT INTO PROJECT2(EVENT_TYPE,ACCOMMODATION,THEME,NO_OF_GUESTS,NO_OF_DAYS_WORKING,TOTAL_BILL,BOOK_ID)VALUES('"+(event)+"','"+(acco)+"','"+(theme)+"','"+(guest)+"','"+(days)+"','"+(bill)+"','"+(id)+"')";
